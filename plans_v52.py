...
# Los cupos de usuarios corresponden a usuarios adicionales del equipo.
# El administrador propietario de la empresa está incluido y no consume estos cupos.
PLANS={
 'Prueba':{'monthly':0,'annual':None,'price':'Gratis · 14 días','description':'Prueba OBRAX Pro durante 14 días.','features':['1 usuario adicional + administrador','Hasta 3 obras','Hasta 10 APUs','Funciones Pro durante 14 días'],'projects':3,'apus':10,'users':1,'modules':{'dashboard','apus','clients','projects','budgets','quotations','control','payables','receivables','cashflow'}},
 'Básico':{'monthly':49900,'annual':499000,'price':'$49.900 + IVA / mes','description':'Para independientes y equipos pequeños que quieren controlar sus obras.','features':['2 usuarios adicionales + administrador','Hasta 5 obras','Hasta 50 APUs','Presupuestos, cotizaciones y control de obra','Cuentas por pagar'],'projects':5,'apus':50,'users':2,'modules':{'dashboard','apus','clients','projects','budgets','quotations','control','payables'}},
 'Pro':{'monthly':99900,'annual':999000,'price':'$99.900 + IVA / mes','description':'Control financiero completo para constructoras y metalmecánicas en crecimiento.','features':['8 usuarios adicionales + administrador','Hasta 20 obras','APUs ilimitados','Cartera, retenciones y flujo de caja','Tesorería, alertas y reportes avanzados'],'projects':20,'apus':None,'users':8,'modules':{'dashboard','apus','clients','projects','budgets','quotations','control','payables','receivables','cashflow'}},
 'Empresa':{'monthly':149900,'annual':1499000,'price':'$149.900 + IVA / mes','description':'Para empresas con múltiples equipos y una operación sin límites.','features':['Usuarios adicionales ilimitados + administrador','Obras y APUs ilimitados','Todo OBRAX Pro','Permisos avanzados y auditoría empresarial','Soporte prioritario Empresa'],'projects':None,'apus':None,'users':None,'modules':{'dashboard','apus','clients','projects','budgets','quotations','control','payables','receivables','cashflow'}}
}
...
def plan_entitlement_guard():
 ...
 # El administrador propietario está incluido y NO consume un cupo de company_users.
 if request.method=='POST' and path=='/team':
  ...
  if limit is not None:
   ...
   if employees>=limit:
    flash(f'Has alcanzado el límite de {limit} usuarios adicionales de tu plan {plan}. El administrador principal está incluido aparte.')
