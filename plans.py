...
PLANS = {
    'Prueba': {
        ...
        'features': ['1 usuario','Hasta 3 obras','Hasta 10 APUs','Funciones Pro durante 14 días'],
    ...
    'Básico': {
        ...
        'features': ['2 usuarios','Hasta 5 obras','Hasta 50 APUs','Presupuestos y cotizaciones PDF','Control de obra y cuentas por pagar'],
    ...
    'Pro': {
        ...
        'features': ['8 usuarios','Hasta 20 obras','APUs ilimitados','Cartera y retenciones','Flujo de caja y tesorería','Alertas y ficha financiera','Reportes avanzados'],
        'modules': PLAN_MODULES['core'] | PLAN_MODULES['financial'],
    },
    'Empresa': {
        ...
        'features': ['Usuarios ilimitados','Obras ilimitadas','APUs ilimitados','Todo OBRAX Pro','Roles y permisos avanzados','Auditoría completa','Soporte prioritario'],
